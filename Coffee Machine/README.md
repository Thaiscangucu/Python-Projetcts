...
This project is divided into several modules (classes) and requires all files to be in the same directory to function properly.

### Prerequisites
* Python 3.x installed.

### How to Run
To start the machine, navigate to the project folder and run:
